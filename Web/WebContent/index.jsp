  ...
  $.ajax({
		...
		success: function(data){
			for(var i=0; i<data.length; i++)
			{
				...
				var content = data[i].Name + " <a href='addStory.jsp?Lat=" + data[i].Latitude +"&Lon="+data[i].Longtitude+"&Name="+data[i].Name+"' id='infowindow'>(Add new Story?)</a> or <a href='timeline.jsp?Lat=" + data[i].Latitude +"&Name="+data[i].Name+"' id='infowindow'>Show stories of place</a>";
